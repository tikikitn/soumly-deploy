...
const CATEGORY_LABEL_OVERRIDES: Record<string, string> = {
	// High-Tech
	"computer-cases": "Boîtiers PC",
	"cle-usb": "Clés USB",
	"disques-ssd": "Disques SSD",
	"alimentation-pc": "Alimentation PC",
	"hubs-et-switches": "Hubs & Switchs",
	"usb-hubs": "Hubs USB",
	"game-controllers": "Manettes de jeu",
	"ensemble-clavier-et-souris": "Ensemble clavier & souris",
	"tapis-de-souris": "Tapis de souris",
	"barrettes-memoires": "Barrettes mémoire",
	...
	"refroidissement-cpu": "Refroidissement CPU",
	"refroidissement-d-ordinateur": "Refroidissement PC",
	"refroidissement-laptop": "Refroidissement portable",
	"stations-d-accueil-ordinateurs": "Stations d'accueil",
	"docking-stations": "Stations d'accueil",
	"tablettes-graphiques": "Tablettes graphiques",
	"cartouches-de-toner": "Cartouches de toner",
	"recharges-d-encre-pour-imprimante": "Recharges d'encre",
	"imprimantes-jets-d-encres": "Imprimantes jet d'encre",
	"imprimantes-laser": "Imprimantes laser",
	"imprimantes-pour-etiquettes": "Imprimantes étiquettes",
	"lecteurs-graveurs-optiques": "Lecteurs & graveurs optiques",
	"cables-video-et-adaptateurs": "Câbles vidéo & adaptateurs",
	"cables-hdmi": "Câbles HDMI",
	"cables-de-reseau": "Câbles réseau",
	"cables-lightning": "Câbles Lightning",
	"cables-audio": "Câbles audio",
	"cables-telephone": "Câbles téléphone",
	"cables-de-telephones-portables": "Câbles téléphone",
	"wireless-access-points": "Points d'accès Wi-Fi",
	"systemes-de-surveillance": "Systèmes de surveillance",
	"cameras-de-surveillance": "Caméras de surveillance",
	"alimentations-d-energie-non-interruptibles": "Alimentations secourues",
	"computer-chargers": "Chargeurs PC",
	"batterie-pc-portable": "Batteries PC portable",
	"serveurs-nas": "Serveurs NAS",
	"moniteurs-video-pour-bebe": "Moniteurs bébé",
	"protections-d-ecran-de-telephone-portable": "Protections d'écran",
	"films-protecteurs": "Films protecteurs",
	"ecrans-solaires": "Écrans solaires",
	// Électroménager
	"machine-a-laver": "Machines à laver",
	"seche-linges": "Sèche-linge",
	"lave-vaisselles": "Lave-vaisselle",
	"plaques-de-cuisson": "Plaques de cuisson",
	"hottes-aspirantes": "Hottes aspirantes",
	"micro-ondes": "Micro-ondes",
	"cuisinieres": "Cuisinières",
	"radiateurs-electriques": "Radiateurs électriques",
	"radiateur-bain-huile": "Radiateurs à bain d'huile",
	"chauffage-a-gaz": "Chauffage à gaz",
	"chauffage-refroidissement-et-qualite-de-l-air": "Climatisation & qualité de l'air",
	"autocuiseurs-pour-cuisiniere": "Autocuiseurs",
	"cave-a-vin": "Caves à vin",
	"groupes-electrogenes": "Groupes électrogènes",
	"machines-a-cafe": "Machines à café",
	"espresso-machine": "Machines espresso",
	"moulins-a-cafe": "Moulins à café",
	"capsules-et-dosettes-de-cafe": "Capsules & dosettes de café",
	"presse-agrumes": "Presse-agrumes",
	"centrifugeuses-et-presse-agrumes": "Centrifugeuses & presse-agrumes",
	"grille-pains": "Grille-pain",
	"grill-panini": "Grills à panini",
	"appareil-a-raclette": "Appareils à raclette",
	"crepieres": "Crêpières",
	"gaufriers": "Gaufriers",
	"robot-petrin": "Robots pétrisseurs",
	"robots-multifonction": "Robots multifonction",
	"balances-de-cuisine": "Balances de cuisine",
	"cuiseur-a-vapeur": "Cuiseurs vapeur",
	"cuiseurs-a-riz": "Cuiseurs à riz",
	"cuiseurs-a-oeufs": "Cuiseurs à œufs",
	"cocotte-minute": "Cocottes-minute",
	"machine-a-pain": "Machines à pain",
	"yaourtieres": "Yaourtières",
	"sorbetieres": "Sorbetières",
	"appareils-a-emballage-sous-vide": "Appareils sous vide",
	"fontaine-eau-fraiche": "Fontaines à eau",
	"nettoyeur-haute-pression": "Nettoyeurs haute pression",
	"accessoires-de-nettoyeur-a-pression": "Accessoires nettoyeurs",
	"aspirateurs-balai": "Aspirateurs balai",
	"aspirateurs-de-table": "Aspirateurs de table",
	"robots-aspirateurs": "Robots aspirateurs",
	"fer-a-repasser": "Fers à repasser",
	"fers-a-boucler": "Fers à boucler",
	"tables-de-repassage": "Tables à repasser",
	"defroisseurs": "Défroisseurs",
	"machines-a-coudre": "Machines à coudre",
	"appareils-anti-moustiques-insectes": "Anti-moustiques",
	"purificateurs-d-air-liquides": "Purificateurs d'air",
	"chauffe-bain": "Chauffe-bain",
	"ventilateurs": "Ventilateurs",
	"climatiseurs": "Climatiseurs",
	"brasseuses-soufflantes-chauffantes": "Brosses soufflantes",
	"brosse-soufflante-chauffante": "Brosse soufflante",
	"seche-cheveux": "Sèche-cheveux",
	"lisseurs": "Lisseurs",
	// Maison & Cuisine
	"ustensiles-de-cuisine-gadgets": "Ustensiles de cuisine",
	"ustensiles-cuisine": "Ustensiles de cuisine",
	"couverts-et-coutellerie": "Couverts & coutellerie",
	"couteaux-de-cuisine": "Couteaux de cuisine",
	"boites-hermetiques-alimentaires": "Boîtes hermétiques",
	"recipients-alimentaires-pour-enfants": "Récipients enfants",
	"moules-a-gateaux": "Moules à gâteaux",
	"moules-a-gaufres": "Moules à gaufres",
	"casseroles-a-sauce": "Casseroles à sauce",
	"faits-tout": "Faits-tout",
	"barbecue-bb-qs": "Barbecues",
	"barbecue-accessoires": "Accessoires barbecue",
	"glacieres": "Glacières",
	"marmites": "Marmites",
	"couteaux-electriques": "Couteaux électriques",
	"services-a-table": "Services de table",
	"nappes-et-sets-de-table": "Nappes & sets de table",
	"meubles-de-salon": "Meubles de salon",
	"ensembles-de-meubles-de-jardin": "Meubles de jardin",
	"mobilier-de-bureau": "Mobilier de bureau",
	"chaises-restaurant": "Chaises",
	"fauteuils-pour-enfants": "Fauteuils enfants",
	"placards-et-armoires-de-chambre-a-coucher": "Placards & armoires",
	"ensembles-de-meubles-pour-enfants": "Meubles enfants",
	"eviers": "Éviers",
	"robinets-de-salle-de-bain": "Robinetterie salle de bain",
	"portes-savon": "Portes-savon",
	"distributeurs-de-savon": "Distributeurs de savon",
	"brosses-et-supports-pour-toilettes": "Brosses de toilettes",
	"piscines-hors-sol": "Piscines hors sol",
	"accessoires-pour-piscine": "Accessoires piscine",
	"flotteurs-de-plage-et-de-piscine": "Flotteurs",
	"jouets-de-piscine": "Jouets de piscine",
	"tondeuses-a-gazon": "Tondeuses à gazon",
	"tailles-haie-electriques": "Tailles-haies électriques",
	"perceuses": "Perceuses",
	"meuleuses-d-angle": "Meuleuses d'angle",
	"marteaux-rotatifs": "Marteaux rotatifs",
	"ponceuses-portatives": "Ponceuses portatives",
	"scies-sauteuses": "Scies sauteuses",
	"visseuses-electriques-et-visseuses-a-percussion": "Visseuses électriques",
	"outils-sans-fil": "Outils sans fil",
	"boites-a-outils": "Boîtes à outils",
	"petites-pieces-et-boites-a-outils": "Petites pièces & boîtes à outils",
	"machines-electriques-a-souder": "Machines à souder",
	"instruments-de-mesure-de-la-distance": "Instruments de mesure",
	"coffres-forts": "Coffres-forts",
	"systemes-videophone": "Systèmes vidéophone",
	"pompes-a-eaux": "Pompes à eau",
	"raccords-des-tuyaux-d-eau": "Raccords de tuyaux",
	"pistolets-eau-buses": "Pistolets & buses à eau",
	"pistolets-a-peinture": "Pistolets à peinture",
	"peintures-pour-loisir": "Peintures loisirs",
	"arrosages-et-irrigations-de-jardin": "Arrosage & irrigation",
	"arroseurs": "Arroseurs",
	"lampes-de-table": "Lampes de table",
	"lampes-a-poser": "Lampes à poser",
	"lampes-de-camping": "Lampes de camping",
	"eclairages-de-plafond": "Plafonniers",
	"eclairage-exterieur": "Éclairage extérieur",
	"torches-et-lampes-de-poche": "Torches & lampes de poche",
	"lampes-a-huile": "Lampes à huile",
	"ampoules-led": "Ampoules LED",
	"bougies-parfums-dinterieur": "Bougies parfumées",
	"decorations-murales": "Décorations murales",
	"decors-muraux": "Décorations murales",
	"tableaux-toiles": "Tableaux & toiles",
	"statues-decoratives": "Statues décoratives",
	"objets-decoratifs": "Objets décoratifs",
	"accessoires-decoratifs": "Accessoires décoratifs",
	"accessoires-de-decoration-d-interieur": "Décoration intérieure",
	"coussins-et-housses-de-coussins": "Coussins & housses",
	"couvertures-et-plaids": "Couvertures & plaids",
	"linge-de-bain": "Linge de bain",
	"linge-de-cuisine": "Linge de cuisine",
	"linge-de-lit": "Linge de lit",
	"serviette-de-plage": "Serviettes de plage",
	"paniers-de-rangement": "Paniers de rangement",
	"boites-de-rangement": "Boîtes de rangement",
	"pot-rangement": "Pots de rangement",
	"poubelles": "Poubelles",
	"paniers-a-linge": "Paniers à linge",
	"tringles-a-rideaux-de-douche": "Tringles de douche",
	"matelas-gonflable": "Matelas gonflables",
	"parasols-de-terrasse": "Parasols de terrasse",
	"tables-de-camping": "Tables de camping",
	"chaises-de-camping": "Chaises de camping",
	"lessives": "Lessives",
	"eponges": "Éponges",
	"detartrants": "Détartrants",
	"accessoires-et-materiel-menagers": "Accessoires ménagers",
	"appareils-dentretien-maison": "Appareils d'entretien",
	"nettoyage": "Nettoyage",
	"sieges-de-toilette-pour-bebe": "Sièges de toilette bébé",
	// Beauté & bien-être
	"serums-visage": "Sérums visage",
	"cremes-et-hydratants-pour-le-visage": "Crèmes hydratantes visage",
	"cremes-pour-le-visage": "Crèmes visage",
	"cremes-hydratantes-pour-le-visage": "Crèmes hydratantes",
	"gels-nettoyants-visage": "Gels nettoyants visage",
	"demaquillant-et-nettoyant": "Démaquillant & nettoyant",
	"eaux-micellaires": "Eaux micellaires",
	"toniques-et-soin-apaisant-visage": "Toniques & soins apaisants",
	"exfoliants-pour-le-visage": "Exfoliants visage",
	"gommages-pour-le-visage": "Gommages visage",
	"masques-pour-le-visage": "Masques visage",
	"masques-visage": "Masques visage",
	"mousses-nettoyantes-pour-le-visage": "Mousses nettoyantes",
	"produits-nettoyants-et-lavants-visage": "Nettoyants visage",
	"soins-anti-rides-anti-age": "Soins anti-rides",
	"soins-apaisants-et-anti-rougeurs": "Soins apaisants",
	"soins-hydratants-nourrissants": "Soins hydratants",
	"bb-creme-cc-creme": "BB crème & CC crème",
	"cremes-teintees": "Crèmes teintées",
	"packs-soins-visage": "Packs soins visage",
	"cremes-et-gels-pour-les-yeux": "Crèmes & gels yeux",
	"produits-de-soins-des-yeux": "Soins des yeux",
	"cremes-pour-les-yeux": "Crèmes yeux",
	"soins-des-yeux": "Soins des yeux",
	"korean-skincare": "K-beauty",
	"eclaircissants-et-anti-taches": "Éclaircissants & anti-taches",
	"soins-des-mains-des-pieds": "Soins mains & pieds",
	"soin-des-pieds": "Soin des pieds",
	"creme-mains": "Crèmes mains",
	"soins-des-ongles": "Soins des ongles",
	"cremes-corporelles-hydratants": "Crèmes corps hydratantes",
	"cremes-corporelles-soin": "Crèmes corps",
	"cremes-et-hydratants-pour-le-corps": "Crèmes hydratantes corps",
	"laits-pour-le-corps": "Laits pour le corps",
	"laits-corporels": "Laits corporels",
	"huiles-pour-le-corps": "Huiles pour le corps",
	"huile-corps": "Huile pour le corps",
	"gommages-corporels": "Gommages corporels",
	"gommage-peeling-corps": "Gommage corps",
	"soins-du-corps-pour-enfants": "Soins corps enfants",
	"produits-de-traitements-dermatologiques-corporels": "Soins dermatologiques",
	"bain-gel-douche": "Bain & gel douche",
	"gels-douche-bain": "Gels douche",
	"gels-douches": "Gels douche",
	"bain-moussant-pour-douche": "Bains moussants",
	"bain-gel-douche-homme": "Gels douche homme",
	"savons-liquides": "Savons liquides",
	"savons-solides": "Savons solides",
	"deodorants-et-antitranspirants": "Déodorants",
	"deodorants-et-anti-transpirants": "Déodorants",
	"deodorant-femme": "Déodorants femme",
	"deodorant-homme": "Déodorants homme",
	"hygiene-intime": "Hygiène intime",
	"gels-de-toilette-intime": "Gels d'hygiène intime",
	"produits-rasage": "Produits de rasage",
	"produits-apres-rasage": "Après-rasage",
	"rasage-apres-rasage": "Rasage & après-rasage",
	"rasoirs-electriques": "Rasoirs électriques",
	"rasoirs-et-tondeuses": "Rasoirs & tondeuses",
	"shampoings-cheveux-beaute": "Shampoings",
	"shampoings": "Shampoings",
	"shampoings-cheveux": "Shampoings",
	"shampooing-et-apres-shampooing": "Shampooing & après-shampooing",
	"apres-shampoings": "Après-shampooings",
	"apres-shampoings-baumes": "Après-shampooings baumes",
	"masques-pour-cheveux": "Masques cheveux",
	"masques-cheveux": "Masques cheveux",
	"masques-capillaires": "Masques capillaires",
	"huiles-cheveux": "Huiles cheveux",
	"huiles-serums-capillaires": "Huiles & sérums capillaires",
	"serums-capillaires-soins": "Sérums capillaires",
	"brumes-capillaires": "Brumes capillaires",
	"couleurs-de-cheveux": "Colorations cheveux",
	"colorations-cheveux": "Colorations cheveux",
	"produits-de-coiffure": "Produits coiffants",
	"laques-cheveux": "Laques cheveux",
	"materiel-de-coiffure": "Matériel de coiffure",
	"peignes-et-brosses-cheveux": "Peignes & brosses",
	"brosses-et-accessoires-cheveux": "Brosses & accessoires",
	"accessoires-pour-cheveux": "Accessoires cheveux",
	"accessoires-cheveux-femme": "Accessoires cheveux femme",
	"accessoires-cheveux-fille": "Accessoires cheveux fille",
	"tondeuses-cheveux": "Tondeuses cheveux",
	"protection-capillaire": "Protection capillaire",
	"protection-solaire-cheveux": "Protection solaire cheveux",
	"cheveux-pour-enfant": "Cheveux enfants",
	"cheveux-hommes": "Cheveux homme",
	"soins-pour-barbe": "Soins barbe",
	"soins-visage-homme": "Soins visage homme",
	"visage-pour-hommes": "Soins visage homme",
	"cremes-solaires": "Crèmes solaires",
	"protection-solaire": "Protection solaire",
	"protection-contre-le-rayonnement-solaire": "Protection solaire",
	"protection-contre-le-rayonnement-solaire-pour-le-corps": "Protection solaire corps",
	"produits-solaires-pour-enfants": "Solaires enfants",
	"packs-solaires": "Packs solaires",
	"vitamines-et-complements-alimentaires": "Vitamines & compléments",
	"complements-alimentaires": "Compléments alimentaires",
	"equipement-medical": "Équipement médical",
	"soins-de-sante": "Soins de santé",
	"tensiometres-pression-arterielle": "Tensiomètres",
	"thermometres": "Thermomètres",
	"pese-personnes": "Pèse-personnes",
	"pese-personne": "Pèse-personne",
	"brosses-a-dents-electrique": "Brosses à dents électriques",
	"brosses-a-dents-electriques": "Brosses à dents électriques",
	"brosses-a-dents": "Brosses à dents",
	"brosses-a-dents-nettoyage": "Brosses à dents",
	"dentifrices": "Dentifrices",
	"dentifrices-dents": "Dentifrices",
	"bains-de-bouche-et-sprays-buccaux": "Bains de bouche",
	"soins-interdentaires": "Soins interdentaires",
	"accessoires-pour-dents": "Accessoires dentaires",
	"gels-dents-gencives": "Gels dents & gencives",
	"blanchiment-des-dents": "Blanchiment des dents",
	"preservatifs": "Préservatifs",
	"gels-lubrifiants-erotisme": "Gels lubrifiants",
	"epilateurs": "Épilateurs",
	"epilation": "Épilation",
	"outils-de-soins-personnels": "Outils de soins",
	"relaxation": "Relaxation",
	"cellulite-et-vergetures": "Cellulite & vergetures",
	"coffrets-pour-femme": "Coffrets femme",
	"coffrets-cadeaux-de-parfum": "Coffrets parfum",
	"produits-de-soins-de-la-peau": "Soins de la peau",
	"produits-de-soins-pour-la-peau": "Soins de la peau",
	"produits-de-traitement-oculaire": "Soins oculaires",
	"soins-du-siege": "Soins du siège",
	"soin-visage": "Soins visage",
	"hygiene-soins": "Hygiène & soins",
	"parfums-beaute": "Parfums",
	"parfums-unisexes": "Parfums unisexes",
	"eaux-de-parfum-pour-femme": "Eaux de parfum femme",
	"eaux-de-parfum-pour-homme": "Eaux de parfum homme",
	"eaux-de-toilette-homme": "Eaux de toilette homme",
	"eaux-de-toilette-femme": "Eaux de toilette femme",
	"coffrets-parfums": "Coffrets parfum",
	"parfum-enfants": "Parfums enfants",
	"parfums-pour-enfants": "Parfums enfants",
	"parfums-et-maquillage-pour-enfants": "Parfums & maquillage enfants",
	// Maquillage
	"fond-de-teint": "Fond de teint",
	"rouges-a-levres": "Rouges à lèvres",
	"rouge-a-levres": "Rouge à lèvres",
	"crayons-a-levres": "Crayons à lèvres",
	"brillants-a-levres": "Brillants à lèvres",
	"baumes-a-levres": "Baumes à lèvres",
	"baume-a-levres": "Baume à lèvres",
	"crayons-pour-les-yeux": "Crayons pour les yeux",
	"fards-a-paupieres": "Fards à paupières",
	"palettes-de-fards-a-paupieres": "Palettes de fards",
	"palette-yeux": "Palettes à paupières",
	"mascaras-et-gels-sourcils": "Mascaras & gels sourcils",
	"pinceaux-pour-maquillage-du-visage": "Pinceaux maquillage",
	"pinceaux-beauty-blender": "Pinceaux & beauty blender",
	"outils-de-maquillage": "Outils de maquillage",
	"fixateur-de-maquillage": "Fixateurs de maquillage",
	"accessoires-maquillage": "Accessoires maquillage",
	"vernis-a-ongles": "Vernis à ongles",
	"accessoires-ongles": "Accessoires ongles",
	"maquillage-enfant": "Maquillage enfant",
	"crayons-sourcils": "Crayons sourcils",
	"coffret-maquillage": "Coffrets maquillage",
	"highlighter": "Highlighters",
	"contouring-highlighter": "Contouring & highlighter",
	"anticernes": "Anti-cernes",
	...
	"poudre": "Poudre",
	"poudres": "Poudres",
	"fard-a-joues": "Fard à joues",
	"fard-a-paupieres": "Fard à paupières",
	"fards": "Fards",
	"bronzer": "Bronzer",
	"primer": "Primer",
	"sourcils": "Sourcils",
	"palette-maquillage": "Palettes maquillage",
	// Mode & accessoires
	"baskets-femme": "Baskets femme",
	"baskets-homme": "Baskets homme",
	"baskets-fille": "Baskets fille",
	"baskets-garcon": "Baskets garçon",
	"baskets-bebe-fille": "Baskets bébé fille",
	"baskets-bebe-garcon": "Baskets bébé garçon",
	"chaussures-de-sport-a-la-mode": "Chaussures de sport",
	"chaussures-de-sport-fille": "Chaussures de sport fille",
	"chaussures-de-sport-garcon": "Chaussures de sport garçon",
	"chaussures-de-sport-femme": "Chaussures de sport femme",
	"chaussures-classiques-homme": "Chaussures homme",
	"chaussures-bottines": "Chaussures & bottines",
	"sandales-femme": "Sandales femme",
	"sandales-fille": "Sandales fille",
	"sandales-garcon": "Sandales garçon",
	"sandales-bebe-fille": "Sandales bébé fille",
	"sandales-bebe-garcon": "Sandales bébé garçon",
	"claquettes-tongs": "Claquettes & tongs",
	"claquettes-femme": "Claquettes femme",
	"claquettes-homme": "Claquettes homme",
	"claquettes-fille": "Claquettes fille",
	"claquettes-bebe-fille": "Claquettes bébé fille",
	"tongs-femme": "Tongs femme",
	"tongs-homme": "Tongs homme",
	"tongs-fille": "Tongs fille",
	"tongs-bebe-fille": "Tongs bébé fille",
	"tongs-bebe-garcon": "Tongs bébé garçon",
	"tongs-garcon": "Tongs garçon",
	"mules-sabots-femme": "Mules & sabots femme",
	"mules-sabots-homme": "Mules & sabots homme",
	"sabots-fille": "Sabots fille",
	"sabots-bebe-fille": "Sabots bébé fille",
	"bottines-femme": "Bottines femme",
	"bottines-homme": "Bottines homme",
	"bottines-fille": "Bottines fille",
	"bottines-bebe-fille": "Bottines bébé fille",
	"escarpins-femme": "Escarpins femme",
	"derbies-femme": "Derbies femme",
	"mocassins-homme": "Mocassins homme",
	"ballerines-fille": "Ballerines fille",
	"chaussons-bebe-fille": "Chaussons bébé fille",
	"bottes-femme": "Bottes femme",
	"t-shirts-homme": "T-shirts homme",
	"t-shirts-femme": "T-shirts femme",
	"t-shirts-fille": "T-shirts fille",
	"t-shirts-garcon": "T-shirts garçon",
	"t-shirts-bebe-fille": "T-shirts bébé fille",
	"t-shirts-bebe-garcon": "T-shirts bébé garçon",
	"t-shirts-de-sport-homme": "T-shirts de sport homme",
	"t-shirts-de-sport-femme": "T-shirts de sport femme",
	"t-shirt-top": "T-shirts & tops",
	"t-shirt-fille": "T-shirt fille",
	"tshirts-femme": "T-shirts femme",
	"hoodies-sweatshirts-homme": "Hoodies & sweats homme",
	"hoodies-sweatshirts": "Hoodies & sweats",
	"streetwear-sweatshirts-hoodies": "Sweats & hoodies",
	"sweats-hoodies-streetwear": "Sweats & hoodies",
	"hoodies-femme": "Hoodies femme",
	"hoodies-garcon": "Hoodies garçon",
	"hoodies-homme": "Hoodies homme",
	"hoodies-fille": "Hoodies fille",
	"chemises-homme": "Chemises homme",
	"chemises-femme": "Chemises femme",
	"chemises-fille": "Chemises fille",
	"chemises-garcon": "Chemises garçon",
	"chemises-bebe-fille": "Chemises bébé fille",
	"chemise-chemisier": "Chemises & chemisiers",
	"chemisiers-femme": "Chemisiers femme",
	"chemise-de-nuit": "Chemises de nuit",
	"polos-homme": "Polos homme",
	"polos-garcon": "Polos garçon",
	"polos-fille": "Polos fille",
	"polos-bebe-garcon": "Polos bébé garçon",
	"polo-femme": "Polos femme",
	"jeans": "Jeans",
	"jeans-homme": "Jeans homme",
	"jeans-femme": "Jeans femme",
	"jeans-fille": "Jeans fille",
	"jeans-garcon": "Jeans garçon",
	"denim-et-jeans": "Denim & jeans",
	"pantalons-homme": "Pantalons homme",
	"pantalons-fille": "Pantalons fille",
	"pantalons-garcon": "Pantalons garçon",
	"pantalons-bebe-garcon": "Pantalons bébé garçon",
	"pantalons-bebe-fille": "Pantalons bébé fille",
	"pantalons-sport-homme": "Pantalons sport homme",
	"pantalons-de-sport-homme": "Pantalons de sport",
	"pantalons-de-sport-femme": "Pantalons de sport femme",
	"shorts-homme": "Shorts homme",
	"shorts-femme": "Shorts femme",
	"shorts-fille": "Shorts fille",
	"shorts-garcon": "Shorts garçon",
	"shorts-bebe-garcon": "Shorts bébé garçon",
	"shorts-de-sport-homme": "Shorts de sport",
	"shorts-de-sport-femme": "Shorts de sport femme",
	"short-streetwear": "Shorts streetwear",
	"vestes-blazers-homme": "Vestes & blazers homme",
	"vestes-blazers": "Vestes & blazers",
	"vestes-femme": "Vestes femme",
	"vestes-homme": "Vestes homme",
	"vestes-fille": "Vestes fille",
	"vestes-garcon": "Vestes garçon",
	"vestes-de-sport-homme": "Vestes de sport",
	"vestes-de-sport-femme": "Vestes de sport femme",
	"doudounes-homme": "Doudounes homme",
	"doudounes-femme": "Doudounes femme",
	"manteaux-homme": "Manteaux homme",
	"surchemises-homme": "Surchemises homme",
	"surchemises-femme": "Surchemises femme",
	"surchemises-garcon": "Surchemises garçon",
	"blouson-homme": "Blousons homme",
	"blousons": "Blousons",
	"gilets": "Gilets",
	"gilets-homme": "Gilets homme",
	"gilets-fille": "Gilets fille",
	"gilets-garcon": "Gilets garçon",
	"gilets-bebe-fille": "Gilets bébé fille",
	"pulls-homme": "Pulls homme",
	"pulls": "Pulls",
	"robes-femme": "Robes femme",
	"robes-fille": "Robes fille",
	"robes-bebe-fille": "Robes bébé fille",
	"jupes": "Jupes",
	"jupes-fille": "Jupes fille",
	"robe-combinaison": "Robes & combinaisons",
	"combinaisons-fille": "Combinaisons fille",
	"combinaisons-bebe-fille": "Combinaisons bébé fille",
	"ensembles-femme": "Ensembles femme",
	"ensembles-homme": "Ensembles homme",
	"ensembles-fille": "Ensembles fille",
	"ensembles-garcon": "Ensembles garçon",
	"ensembles-bebe-fille": "Ensembles bébé fille",
	"ensembles-bebe-garcon": "Ensembles bébé garçon",
	"ensembles-pyjamas-femme": "Ensembles pyjama femme",
	"ensembles-survetements-homme": "Survêtements homme",
	"ensembles-survetements-femme": "Survêtements femme",
	"ensembles-survetements-garcon": "Survêtements garçon",
	"ensembles-streetwear": "Ensembles streetwear",
	"jogging-survetements": "Joggings & survêtements",
	"joggings-sport-homme": "Joggings sport homme",
	"joggings-femme": "Joggings femme",
	"joggings-garcon": "Joggings garçon",
	"joggings-bebe-garcon": "Joggings bébé garçon",
	"jogging-fille": "Joggings fille",
	"joggers-fille": "Joggers fille",
	"joggers-garcon": "Joggers garçon",
	"survetements-homme": "Survêtements homme",
	"legging-sport-femme": "Leggings de sport",
	"leggings-fille": "Leggings fille",
	"leggings-bebe-fille": "Leggings bébé fille",
	"maillots-de-bain-homme": "Maillots de bain homme",
	"maillots-de-bain-garcon": "Maillots de bain garçon",
	"maillots-de-bain-fille": "Maillots de bain fille",
	"maillots-de-bain-bebe-garcon": "Maillots de bain bébé garçon",
	"maillots-de-bain-bebe-fille": "Maillots de bain bébé fille",
	"hauts-maillots-de-bain-femme": "Hauts de maillot femme",
	"bas-maillots-de-bain-femme": "Bas de maillot femme",
	"hauts-de-sport-femme": "Hauts de sport femme",
	"hauts-de-sport-homme": "Hauts de sport homme",
	"hauts-sportswear-homme": "Hauts sportswear",
	"bas-sportswear-homme": "Bas sportswear",
	"brassieres-de-sport-femme": "Brassières de sport",
	"sous-vetements-homme": "Sous-vêtements homme",
	"sous-vetements-femme": "Sous-vêtements femme",
	"sous-vetements-garcon": "Sous-vêtements garçon",
	"sous-vetements-fille": "Sous-vêtements fille",
	"lingerie-nuisette-sexy": "Lingerie & nuisettes",
	"nuisette-sexy": "Nuisettes",
	"string-sexy": "Strings",
	"haut-lingerie": "Hauts de lingerie",
	"bas-lingerie": "Bas de lingerie",
	"soutiens-gorge": "Soutiens-gorge",
	"pyjamas-femme": "Pyjamas femme",
	"pyjamas-homme": "Pyjamas homme",
	"pyjamas-fille": "Pyjamas fille",
	"pyjamas-garcon": "Pyjamas garçon",
	"pyjamas-bebe-fille": "Pyjamas bébé fille",
	"pyjamas-bebe-garcon": "Pyjamas bébé garçon",
	"chaussettes-femme": "Chaussettes femme",
	"chaussettes-homme": "Chaussettes homme",
	"chaussettes-fille": "Chaussettes fille",
	"chaussettes-garcon": "Chaussettes garçon",
	"chaussettes-bebe-fille": "Chaussettes bébé fille",
	"chaussettes-de-sport-femme": "Chaussettes de sport",
	"chaussettes-de-sport-homme": "Chaussettes de sport",
	"collants-femme": "Collants femme",
	"collants-fille": "Collants fille",
	"ceintures-homme": "Ceintures homme",
	"ceintures-femme": "Ceintures femme",
	"casquettes-femme": "Casquettes femme",
	"casquettes-homme": "Casquettes homme",
	"casquettes-fille": "Casquettes fille",
	"casquettes-garcon": "Casquettes garçon",
	"chapeaux-casquettes-homme": "Chapeaux & casquettes homme",
	"chapeaux-femme": "Chapeaux femme",
	"chapeaux-fille": "Chapeaux fille",
	"chapeaux-bebe-fille": "Chapeaux bébé fille",
	"bonnets-femme": "Bonnets femme",
	"bonnets-homme": "Bonnets homme",
	"echarpes-homme": "Écharpes homme",
	"foulards-femme": "Foulards femme",
	"gants-de-sport": "Gants de sport",
	"cravates-homme": "Cravates homme",
	"sacs-femme": "Sacs femme",
	"sacs-a-main-femme": "Sacs à main femme",
	"sacs-a-mains-et-sacs-en-bandouliere": "Sacs à main & bandoulière",
	"sacs-a-dos-femme": "Sacs à dos femme",
	"sacs-a-dos-homme": "Sacs à dos homme",
	"sacs-a-dos-fille": "Sacs à dos fille",
	"sacs-a-dos-garcon": "Sacs à dos garçon",
	"sacs-a-dos": "Sacs à dos",
	"sac-a-dos-scolaire": "Sacs à dos scolaires",
	"sacoche-femme": "Sacroches femme",
	"sacoche-homme": "Sacroches homme",
	"sacoches-ordinateurs-portables": "Sacroches PC portable",
	"portefeuilles-femme": "Portefeuilles femme",
	"portefeuilles-homme": "Portefeuilles homme",
	"cartables": "Cartables",
	"bagages": "Bagages",
	"valises": "Valises",
	"sacs-isotherme": "Sacs isothermes",
	"sacs-de-sport-femme": "Sacs de sport",
	"trousse-fille": "Trousses fille",
	"trousse-garcon": "Trousses garçon",
	"montres-classiques-homme": "Montres homme",
	"montres-classiques-femme": "Montres femme",
	"montres-connectees-femme": "Montres connectées femme",
	"montres-fille": "Montres fille",
	"montres-garcon": "Montres garçon",
	"accessoires-pour-smartwatch": "Accessoires smartwatch",
	"colliers-femme": "Colliers femme",
	"colliers": "Colliers",
	"bracelets-femme": "Bracelets femme",
	"boucles-doreilles": "Boucles d'oreilles",
	"lunettes-femme": "Lunettes femme",
	"lunettes-homme": "Lunettes homme",
	"lunettes-de-soleil": "Lunettes de soleil",
	"accessoires-chaussures": "Accessoires chaussures",
	"chapeaux": "Chapeaux",
	"bodys": "Bodys",
	"bodys-bebe-fille": "Bodys bébé fille",
	"debardeurs-homme": "Débardeurs homme",
	"debardeurs-femme": "Débardeurs femme",
	"debardeurs-fille": "Débardeurs fille",
	"debardeurs-garcon": "Débardeurs garçon",
	"debardeurs-bebe-garcon": "Débardeurs bébé garçon",
	"tapis-d-eveil-et-de-jeux-pour-bebes": "Tapis d'éveil bébé",
	"blouses-fille": "Blouses fille",
	"salopettes-fille": "Salopettes fille",
	"streetwear-t-shirts": "T-shirts streetwear",
	"streetwear-chaussures": "Chaussures streetwear",
	// Bébé & enfants
	"biberons": "Biberons",
	"biberons-et-tetines": "Biberons & tétines",
	"biberons-et-vaisselle-pour-bebes": "Biberons & vaisselle bébé",
	"tetines-pour-bebe": "Tétines bébé",
	"tetines-pour-biberons": "Tétines de biberons",
	"tires-lait": "Tire-laits",
	"chauffe-biberons": "Chauffe-biberons",
	"bavoirs-pour-bebes": "Bavoirs bébé",
	"couches-jetables-pour-bebe": "Couches bébé",
	"couches-jetables": "Couches jetables",
	"bain-de-bebe": "Bain de bébé",
	"bains-de-bebe": "Bains de bébé",
	"baignoires-pour-bebes": "Baignoires bébé",
	"aspirateurs-nasaux-pour-bebe": "Aspirateurs nasaux bébé",
	"lingettes-bebe": "Lingettes bébé",
	"creme-de-change": "Crèmes de change",
	"hygiene-et-soins-du-bebe": "Hygiène & soins bébé",
	"produits-de-soins-de-cheveux-de-bebe": "Soins cheveux bébé",
	"poussettes-pour-bebe": "Poussettes",
	"parcs": "Parcs",
	"sieges-auto-bebe": "Sièges auto",
	"chaises-hautes": "Chaises hautes",
	"sommeil-de-l-enfant": "Sommeil de l'enfant",
	"lumieres-de-nuit-pour-bebe": "Veilleuses",
	"tetes-de-rechange": "Tétines de rechange",
	"jeux": "Jeux",
	"jeux-de-societe": "Jeux de société",
	"jeux-d-imitation": "Jeux d'imitation",
	"jouets-d-apprentissage": "Jouets d'apprentissage",
	"jouets-et-jeux-d-eveil-d-adresse": "Jouets d'éveil",
	"jouets-electroniques-pour-enfants": "Jouets électroniques",
	"jouets-sets-de-jeux": "Sets de jeux",
	"jouets-de-construction": "Jouets de construction",
	"jouets-musicaux": "Jouets musicaux",
	"jouets-pour-bebes": "Jouets bébé",
	"jouets-interactifs": "Jouets interactifs",
	"jouets-a-chevaucher": "Jouets à chevaucher",
	"kits-de-loisirs-creatifs-et-artistiques-pour-enfants": "Loisirs créatifs enfants",
	"coffrets-de-sciences-pour-enfant": "Coffrets de sciences",
	"puzzles": "Puzzles",
	"peluches": "Peluches",
	"poupees": "Poupées",
	"figurines-pour-enfants": "Figurines",
	"hochets": "Hochets",
	"vehicules-pour-enfants": "Véhicules enfants",
	"equipements-pour-terrain-de-jeux": "Terrains de jeux",
	"equipements-et-jeux-de-recreation-et-sportifs": "Jeux de plein air",
	"piscines-de-jeux-pour-enfants": "Piscines de jeux",
	"coffrets-pour-les-bebes": "Coffrets bébé",
	"accessoires-de-bain-pour-bebes": "Accessoires de bain bébé",
	// Sport
	"tenus-et-vetements-de-sport": "Vêtements de sport",
	"vetements-de-sport-garcon": "Vêtements de sport garçon",
	"trottinettes-electriques": "Trottinettes électriques",
	"scooters-electriques": "Scooters électriques",
	"velos-d-appartement": "Vélos d'appartement",
	"velos-et-accessoires": "Vélos & accessoires",
	"tapis-de-course": "Tapis de course",
	"accessoires-de-musculation-des-mains": "Accessoires de musculation",
	"halteres": "Haltères",
	"bancs-de-musculation": "Bancs de musculation",
	"equipements-de-fitness": "Équipements de fitness",
	"equipement-pour-sports-de-raquette": "Sports de raquette",
	"equipement-pour-sports-nautiques": "Sports nautiques",
	"kits-de-natation": "Kits de natation",
	"lunettes-de-natation": "Lunettes de natation",
	"ballons-de-football": "Ballons de football",
	"alimentation-du-sportif": "Nutrition sportive",
	"nutrition-sportive": "Nutrition sportive",
	"accessoires-de-sport": "Accessoires de sport",
	"accessoires-de-sport-homme": "Accessoires de sport",
	"accessoires-sport-fille": "Accessoires de sport",
	"sports-loisirs": "Sports & loisirs",
	"gourdes-hydratation-femme": "Gourdes d'hydratation",
	"lunivers-sport-femme": "Univers sport femme",
	"lunivers-sport-homme": "Univers sport homme",
	// Bureau
	"fournitures-de-bureau": "Fournitures de bureau",
	"calculatrices": "Calculatrices",
	"destructeur-de-papier": "Destructeurs de papier",
	"tableaux-blancs": "Tableaux blancs",
	"tableaux-d-affichage-accessoires": "Tableaux d'affichage",
	"agrafeuses": "Agrafeuses",
	"agrafes": "Agrafes",
	"marqueurs": "Marqueurs",
	"stylos-feutres": "Stylos feutres",
	"stylos-fins": "Stylos fins",
	"stylos-a-bille": "Stylos à bille",
	"crayons-de-couleur": "Crayons de couleur",
	"relieuses": "Relieuses",
	"laminateurs-et-fournitures": "Laminateurs",
	"organiseurs-de-bureau": "Organiseurs de bureau",
	"produits-d-archivage": "Produits d'archivage",
	"systemes-de-reliure-pour-maintenir-les-papiers-et-les-documents": "Systèmes de reliure",
	"trousses-a-crayons": "Trousses à crayons",
	"blocs-notes": "Blocs-notes",
	"compas-a-secteur": "Compas",
	"ciseaux-a-bouts-ronds": "Ciseaux à bouts ronds",
	"caisses-enregistreuses": "Caisses enregistreuses",
	"accessoires-de-systeme-de-paiement-en-point-de-vente": "Systèmes de paiement",
	"livres": "Livres",
	"livres-et-pages-a-colorier": "Livres à colorier",
	// Animaux
	"nourriture-pour-chiens-et-chats": "Nourriture chien & chat",
	"litieres-et-effractions-pour-chiens-et-chats": "Litières & effractions",
	"colliers-harnais-et-laisses-pour-chiens-et-chats": "Colliers & laisses",
	"gamelles": "Gamelles",
	// Jeux vidéo / TV
	"consoles-de-jeux": "Consoles de jeux",
	"jeux-videos": "Jeux vidéo",
	"accessoires-de-console-de-jeux": "Accessoires de console",
	"sieges-pour-jeux-videos": "Sièges gaming",
	"home-cinema-systems": "Home cinéma",
	"enceintes-portables": "Enceintes portables",
	"haut-parleurs-conference": "Haut-parleurs conférence",
	"haut-parleurs": "Haut-parleurs",
	"radios-portables": "Radios portables",
	"tv-accessories": "Accessoires TV",
	"recepteurs-tv": "Récepteurs TV",
	"digital-tv-boxes": "Box TV",
	"projecteurs": "Projecteurs",
	"microphones": "Microphones",
	"platines": "Platines",
	"pieces-et-accessoires-d-equipements-audiovisuels": "Accessoires audiovisuels",
	"equipements-de-scene-et-de-studio": "Équipements de scène",
	"appareils-photo-numeriques": "Appareils photo numériques",
	"camera-lenses": "Objectifs photo",
	"camera-tripods": "Trépieds",
	"camescopes": "Caméscopes",
	"accessoires-de-camera-camescope": "Accessoires photo",
	"batons-supports-pour-selfies": "Bâtons selfie",
	"etuis-et-housses-d-appareils-photo": "Étuis & housses photo",
	"pellicules-polaroid": "Pellicules Polaroid",
	"moniteurs": "Écrans",
	"ecrans": "Écrans",
	"tablettes": "Tablettes",
	...
	"parfums": "Parfums",
	"accessoires-parfums": "Accessoires parfums",
	"corps": "Soins corps",
	"cheveux": "Soins cheveux",
	"levres": "Soins lèvres",
	"styling": "Coiffage",
	"rasage": "Rasage",
	"parfums-pour-femme": "Parfums femme",
	"demaquillants-yeux": "Démaquillants yeux",
	"soin-de-la-peau-de-l-apos-enfant": "Soins peau enfant",
	"erotisme-corps": "Soins corps",
	"zone-de-la-bouche-et-des-levres": "Soins lèvres",
	"accessoires-pour-corps": "Accessoires corps",
	"accessoires-pour-visage": "Accessoires visage",
	"materiel-pour-imprimante": "Matériel pour imprimante",
	"papiers-imprimante": "Papiers imprimante",
	"tambours-d-imprimante": "Tambours d'imprimante",
	"boitiers-d-equipement-reseau": "Boîtiers réseau",
	"boitiers-de-disques-de-stockage": "Boîtiers de stockage",
	"supports-d-ecrans": "Supports d'écran",
	"supports": "Supports",
	"stockages": "Stockage",
	"composants": "Composants PC",
	"logiciels": "Logiciels",
	"logiciels-systemes-dexploitation": "Systèmes d'exploitation",
	"acces-et-controles": "Accès & contrôles",
	"piles-domestiques": "Piles",
	"ordinateurs": "Ordinateurs",
	"informatique": "Informatique",
	"image-et-son": "Image & son",
	"telephones-fixes": "Téléphones fixes",
	"car-holder": "Supports voiture",
	"batteries": "Batteries",
	"nourriture-boissons-tabac": "Alimentation & boissons",
	"divers": "Divers",
	"cuisine": "Cuisine",
	"rangement": "Rangement",
	"jardin": "Jardin",
...
// Sample products across a set of category slugs (used by universe pages).
// Lightweight: returns up to `limit` ProductSummary, ordered by popularity.
export function getProductsByCategories(categorySlugs: string[], limit = 4): ProductSummary[] {
	const slugSet = new Set(categorySlugs);
	return products
		.filter((product) => slugSet.has(product.categorySlug))
		.sort((a, b) => b.stores - a.stores || b.discount - a.discount || a.price - b.price)
		.slice(0, limit)
		.map(toSummary);
}
