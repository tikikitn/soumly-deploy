    ...
    <div className="soumly-pages">
      <header className="sm-site-header">
        <div className="sm-page-shell sm-header-row">
          ...
          <div className="sm-header-actions">
            ...
            <Link className="sm-login-button" href="/compte"><UserRound size={19} /> <span>Se connecter</span></Link>
      ...
      <footer className="sm-footer">
        <div className="sm-page-shell sm-footer-grid">
          ...
          <div><h3>Soumly</h3><a href="#a-propos">À propos</a><a href="#contact">Contact</a><a href="#confidentialite">Confidentialité</a></div>
        </div>
        <div className="sm-page-shell sm-footer-bottom"><span>© 2026 Soumly. Tous droits réservés.</span><span>Prix affichés à titre indicatif · Données de démonstration</span></div>
      </footer>
