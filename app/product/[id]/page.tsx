...
import { ArrowLeft, RefreshCw, ShieldCheck, Store, Tag } from "lucide-react";
...
export default function ProductPage() {
	...
	const offers: Offer[] = (
		(product as any).offers && (product as any).offers.length
				...
				<div className="product-detail__info">
					...
					<div className="trust-strip" style={{ marginTop: 16 }}>
						<div>
							<ShieldCheck size={20} />
							<span>
								<strong>Prix garanti</strong> Soumly vérifie
							</span>
						</div>
						<div>
							<RefreshCw size={20} />
							<span>
								<strong>Mis à jour</strong> Aujourd&apos;hui
							</span>
						</div>
					</div>
				</div>
			...
			<section className="products-section" style={{ marginTop: 40 }}>
				...
				{offers.length === 1 ? (
					<p style={{ marginTop: 16, color: "#888", fontSize: 14 }}>
						D&apos;autres boutiques tunisiennes (Mytek, Spacenet, Wiki…) seront comparées ici dès
						que leurs prix seront ajoutés.
					</p>
				) : null}
			</section>
		</main>
