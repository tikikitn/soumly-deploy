    ...
    <article className="product-card">
      ...
      <a className="product-card__content" href={`/produit/${product.id}`}>
        ...
        <div className="product-card__details">
          ...
          {product.oldPrice > product.price ? <span className="old-price">{formatPrice(product.oldPrice)}</span> : null}
    ...
    <main id="accueil">
      ...
      <section className="hero page-shell" aria-labelledby="hero-title">
        ...
        <div className="hero-visual" aria-label="Produits populaires sur Soumly">
          ...
          <div className="hero-price-note">
            <TrendingPriceIcon />
            <span>
              <strong>{maximumDiscount > 0 ? `Jusqu’à −${maximumDiscount}%` : "Comparez les offres"}</strong>
      ...
      <section className="products-section page-shell" id="populaires" aria-labelledby="populaires-title">
        ...
        <div className="product-rail" ref={popularRail}>
          {products.filter((product) => product.stores > 1).slice(0, 12).map((product) => (
            <ProductCard
              key={product.id}
              product={product}
              isFavorite={favorites.has(product.id)}
      ...
      <footer className="site-footer">
        <div className="page-shell footer-grid">
          <div className="footer-brand">
            ...
            <span className="demo-note">Vérifiez toujours le prix final et la disponibilité chez le marchand.</span>
          </div>
          <div>
            <h3>Soumly</h3>
            <a href="/categories">Catégories</a>
          ...
          >
            ...
            <div className="modal-product">
              ...
              <div>
                ...
                <small>{selectedProduct.stores} boutique{selectedProduct.stores > 1 ? "s" : ""} référencée{selectedProduct.stores > 1 ? "s" : ""}</small>
              </div>
            </div>
            ...
            <p className="modal-disclaimer">
              Les prix proviennent du dernier relevé importé. Vérifiez le prix final et la disponibilité chez le marchand.
            </p>
            <a className="compare-button" href={`/produit/${selectedProduct.id}`}>Voir la comparaison détaillée <ArrowRight size={16} /></a>
          </section>
        </div>
      ) : null}
